package com.timerchina.cluster.lda;
...
public class LDAOption implements Serializable {
	...
	public int K = 3;  //Specify the number of topics  ///
	
	public double alpha = (double)50/K;  //Specify alpha  ////
	public double beta = 0.1;  //Specify beta

	public int niters = 100;  //Specify the number of iterations  //
